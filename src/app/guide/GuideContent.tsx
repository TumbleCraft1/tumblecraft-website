      ...
      <article className="bg-background-secondary border border-border-color rounded-xl p-8 md:p-12">
        <div 
          className="prose prose-invert prose-lg max-w-none
            ...
            prose-h1:text-3xl prose-h1:text-primary prose-h1:mb-6 prose-h1:mt-8 first:prose-h1:mt-0
            ...
            prose-code:text-primary prose-code:bg-background prose-code:px-2 prose-code:py-1 prose-code:rounded prose-code:text-sm
            ...
            prose-blockquote:border-l-primary prose-blockquote:text-foreground-secondary prose-blockquote:bg-background prose-blockquote:px-4 prose-blockquote:py-2 prose-blockquote:rounded-r-lg
